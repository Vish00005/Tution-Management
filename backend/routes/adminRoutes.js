...
const { getStudents, addStudent, deleteStudent, updateStudent, getBatches, addBatch, deleteBatch, addSubject, getAttendance, markAttendance, updateAttendance, deleteAttendance, addMarksheet, getOverviewStats, getMarksheets, updateMarksheet, deleteMarksheet, updateBatchFees, updateStudentFees } = require('../controllers/adminController');
...
router.route('/attendance/:id').put(updateAttendance).delete(deleteAttendance);

router.route('/marksheets').get(getMarksheets).post(addMarksheet);
router.route('/marksheets/:id').put(updateMarksheet).delete(deleteMarksheet);
